...
function CardModel({ index,place, expandedIndex, setExpandedIndex  }) {
  ...
  return (
    <>
    <Card key={place.idPlace} sx={{ width: '80%',margin:5 }}>
      <CardHeader
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        ...
        <div>
          ...
          <b>Referência:</b>{place.descReference 
                              ? place.descReference
                              : <i>Sem Referência</i>}<br/>
        ...
        <div style={{marginTop:'20px'}}>
          <IconButton onClick={handleOpenModal}>
            <DeleteIcon style={{fontSize:'15px'}}/><span style={{fontSize:'15px'}}>Deletar</span>
          </IconButton>

          <IconButton aria-label="share" onClick={gotoEditMode}>
              <EditIcon style={{fontSize:'15px'}}/><span style={{fontSize:'15px'}}>Editar</span> 
          </IconButton>
        </div>
        </CardContent>
